...
\begin{itemize}
	...
	\begin{equation} \label{D.1.1}
		\frac{\partial \mathcal{L}}{\partial \phi^a} - \partial_\mu \Big( \frac{\partial \mathcal{L}}{\partial (\partial_\mu \phi^a)} \Big) = 0
	\end{equation}
...
\begin{itemize}
	...
	\begin{equation}
		\begin{dcases}
			\partial_0 \phi^a = \frac{\partial \mathcal{H}}{\partial \pi_a} \\
			- \partial_0 \pi^a = \frac{\partial \mathcal{H}}{\partial \phi^a} - \partial_i \Big( \frac{\partial \mathcal{H}}{\partial (\partial_i \phi^a)} \Big)
		\end{dcases}
	\end{equation}
	\begin{itemize}
		\item 第二个方程可以写成更紧凑的形式,
		\begin{equation}
			\partial_\mu \pi_a^\mu = \frac{\partial \mathcal{H}}{\partial \phi^a}
		\end{equation}
	\end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{tcolorbox}[title=proof:]
		\begin{align}
			D_\lambda \mathcal{L} &= \frac{\partial \mathcal{L}}{\partial \phi^a} D_\lambda \phi^a + \frac{\partial \mathcal{L}}{\partial (\partial_\mu \phi^a)} \partial_\mu D_\lambda \phi^a \notag \\
			&= \Big( \frac{\partial \mathcal{L}}{\partial \phi^a} - \partial_\mu \Big( \frac{\partial \mathcal{L}}{\partial (\partial_\mu \phi^a)} \Big) \Big) D_\lambda \phi^a + \partial_\mu \Big( \underbrace{\frac{\partial \mathcal{L}}{\partial (\partial_\mu \phi^a)}}_{= \pi_a^\mu} D_\lambda \phi^a \Big)
		\end{align}
		代入 \eqref{D.1.1}, 得...
	\end{tcolorbox}
...
\begin{itemize}
	\item Lorentz transformation 下坐标做变换 $x'^\mu = \Lambda^\mu_\nu x^\nu$, 其中 $\Lambda$ 满足,
	\begin{equation}
	...
	\item 有,
	\begin{equation}
		D_\lambda \phi^a = - {\epsilon^\mu}_\nu x^\nu \partial_\mu \phi^a \quad \text{and} \quad D_\lambda \mathcal{L} = - {\epsilon^\mu}_\nu x^\nu \partial_\mu \mathcal{L} = - \epsilon_{\mu \nu} \partial^\mu(x^\nu \mathcal{L})
	\end{equation}
	代入 \eqref{D.2.12},
	\begin{equation}
