...
\begin{itemize}
	...
	\begin{tcolorbox}[title=calculation:]
		...
		\end{align}
		注意到, 由于 $(\bar{\eta}_i D_i \eta_i) \in \mathbb{C}$, 所以 $\eta, \bar{\eta}$ 的积分顺序并不重要, 唯一的要求是 $\eta$ 和 $\bar{\eta}$ 的积分顺序互相对应, 即 $d\eta_i d\eta_j \leftrightarrow d\bar{\eta}_i d\bar{\eta}_j$.
	\end{tcolorbox}
